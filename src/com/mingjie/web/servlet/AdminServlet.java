...
public class AdminServlet extends BaseServlet {
    ...
    public void showProductListAdmin(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        request.getRequestDispatcher("admin/product/lwj-list.jsp").forward(request,response);
    }
    ...
    public void showOrderList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        request.getRequestDispatcher("/admin/order/lwj-list.jsp").forward(request,response);
    ...
    public void showAllCategory(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        request.getRequestDispatcher("/admin/category/lwj-list.jsp").forward(request,response);
    }
}
