    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            <c:if test="${empty user}">
                <li><a href="lwj-login.jsp">登录</a></li>
                <li><a href="lwj-register.jsp">注册</a></li>
            </c:if>
            <c:if test="${!empty user}">
            ...
            <li><a href="lwj-cart.jsp">购物车</a></li>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/lwj-default.jsp">首页</a>
            </div>
