		...
		<div class="container">
						...
						<tbody>
                            ...
                            <c:forEach items="${cart.cartItem}" var="entry">
                                <tr class="active">
                                    ...
                                    <td width="10%">
                                        <input type="text" disabled="disabled" name="quantity" value="${entry.value.num}" maxlength="4" size="10">
                                    </td>
                                    <td width="15%">
                                        <span class="subtotal">￥${entry.value.subTotal}</span>
                                    </td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/product?method=delCartItem&pid=${entry.value.product.pid}" class="delete">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/product?method=commitOrder">
