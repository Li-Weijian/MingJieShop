...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form class="form-horizontal" id="payFrom" style="margin-top: 5px; margin-left: 150px;" action="/product" method="post">
                <%--提交的方法参数--%>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3" name="name"
							value="${user.username}" placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
			...
			<hr />
                ...
                <div style="margin-top: 5px; margin-left: 150px;">
                    ...
                    <p style="text-align: right; margin-right: 100px;">
                        <a href="javascript:void(0)" onclick="finalOrder()">
